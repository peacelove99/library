package com.obliviate;

import com.obliviate.bean.Admin;
import com.obliviate.global.Section;
import com.obliviate.global.AdminDetail;
import com.obliviate.global.plugin.SectionManager;
import com.obliviate.service.AdminService;
import com.obliviate.global.plugin.ViewManager;
import com.gn.decorator.GNDecorator;
import com.gn.decorator.options.ButtonType;
import com.obliviate.module.loader.Loader;
import com.obliviate.module.main.Main;
import com.obliviate.service.impl.AdminServiceImpl;
...
public class App extends Application {
    ...
    public  void start(Stage primary) {
        ...
        stylesheets.addAll(
                getClass().getResource("/com/obliviate/theme/css/fonts.css").toExternalForm(),
                getClass().getResource("/com/obliviate/theme/css/material-color.css").toExternalForm(),
                getClass().getResource("/com/obliviate/theme/css/skeleton.css").toExternalForm(),
                getClass().getResource("/com/obliviate/theme/css/light.css").toExternalForm(),
                getClass().getResource("/com/obliviate/theme/css/bootstrap.css").toExternalForm(),
                getClass().getResource("/com/obliviate/theme/css/shape.css").toExternalForm(),
                getClass().getResource("/com/obliviate/theme/css/typographic.css").toExternalForm(),
                getClass().getResource("/com/obliviate/theme/css/helpers.css").toExternalForm(),
                getClass().getResource("/com/obliviate/theme/css/master.css").toExternalForm()
        );

        decorator.setMaximized(true);
        decorator.getStage().getIcons().add(new Image("/com/obliviate/module/media/logo2.png"));
        decorator.show();
    ...
    private void load(String module, String name){
        try {
            ViewManager.getInstance().put(
                    name,
                    FXMLLoader.load(getClass().getResource("/com/obliviate/module/" + module + "/" + name + ".fxml"))
            );
            preloaderNotify();
        } catch (IOException e) {
            e.printStackTrace();
