 ...
 */
package com.obliviate.module.main;

import com.gn.GNAvatarView;
import com.obliviate.global.factory.AlertCell;
import com.obliviate.global.plugin.ViewManager;
...
public class Main implements Initializable {
    ...
    private String path = "/com/obliviate/theme/css/";
    ...
    private void addSubPop() throws Exception {
        popup.setContentNode(FXMLLoader.load(getClass().getResource("/com/obliviate/module/main/Popover.fxml")));
    ...
    private void addEvent(Node node) {
        ...
        scrollPane.getStylesheets().add(getClass().getResource("/com/obliviate/theme/css/custom-scroll.css").toExternalForm());
...
//        Popover.ctrl.options.getChildren().clear();
    ...
    private void loadContentPopup() {
        try {
            popContent = FXMLLoader.load(getClass().getResource("/com/obliviate/module/main/Config.fxml"));
            popConfig.getRoot().getStylesheets().add(getClass().getResource("/com/obliviate/theme/css/poplight.css").toExternalForm());
    ...
    private void openMessages() {
        if (!pop.isShowing()) {
            ...
            avatar1.setImage(new Image(getClass().getResource("/com/obliviate/module/media/man.png").toExternalForm()));
            avatar2.setImage(new Image(getClass().getResource("/com/obliviate/module/media/woman.png").toExternalForm()));
            avatar3.setImage(new Image(getClass().getResource("/com/obliviate/module/media/man.png").toExternalForm()));
            ...
            listView.getStylesheets().add(getClass().getResource("/com/obliviate/theme/css/custom-scroll.css").toExternalForm());


            pop.getRoot().getStylesheets().add(getClass().getResource("/com/obliviate/theme/css/poplight.css").toExternalForm());
    ...
    private void openNotification() {
        if (!pop.isShowing()) {
            ...
            avatar1.setImage(new Image(getClass().getResource("/com/obliviate/module/media/warning-35.png").toExternalForm()));
            avatar2.setImage(new Image(getClass().getResource("/com/obliviate/module/media/error-35.png").toExternalForm()));
            avatar3.setImage(new Image(getClass().getResource("/com/obliviate/module/media/notification-35.png").toExternalForm()));
